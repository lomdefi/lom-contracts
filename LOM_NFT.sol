...
contract LOMMdate is NFToken {
    ...
    function _mint(address _to) internal {
        super._mint(_to);
        tokens.push(tokenID);
        idToIndex[tokenID] = tokens.length - 1;
...
contract LOM_NFT is LOMMdate,Ownable{
        ...
        onlyManager
    {
        ...
        super._setTokenAttributes(tokenID,_stype,_ttype,_power);
    }
